...
-- ===== 创建 UI（放在 CoreGui，避免重生消失） =====
local gui = Instance.new("ScreenGui")
gui.Name = "视角冲刺UI"
gui.Parent = game:GetService("CoreGui")   -- 关键修改
...
btn.Position = UDim2.new(0.5, -70, 0, 108)
btn.Text = "开启"
...
print("✅ 加载完成 | UI 已固定在 CoreGui，重生不会消失")
print("📌 点「开启」使用，关闭按钮依然有效")